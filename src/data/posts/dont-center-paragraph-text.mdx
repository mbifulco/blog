...
The British Dyslexia Association provides a [dyslexia-friendly style guide] (https://www.bdadyslexia.org.uk/advice/employers/creating-a-dyslexia-friendly-workplace/dyslexia-friendly-style-guide), which calls out a simple rule for text:
...
Generally speaking, if you're certain that your text will fit on _one line,_ it may be okay to center it.  This generally applies to page titles, captions on pictures, and things of that nature. 
