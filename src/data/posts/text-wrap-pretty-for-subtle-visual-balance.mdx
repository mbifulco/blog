...
date: 04-30-2026
updated: 06-23-2026
tldr: '`text-wrap: pretty` tells the browser to avoid awkward line breaks, mostly orphaned words on the last line of a paragraph. Use it on body text (and `text-wrap: balance` on headings). Browser support is broad, the fallback is harmless, so there is no real downside.'
---
...
<FAQ>
  <FAQItem question="What does text-wrap: pretty do?">
  ...
  <FAQItem question="What is the difference between text-wrap: pretty and text-wrap: balance?">
  ...
  <FAQItem question="Is text-wrap: pretty supported in all browsers?">
  ...
  <FAQItem question="How do I use text-wrap: pretty with Tailwind CSS?">
