---
title: Publish past newsletters to your Next.js site using the ConvertKit API
excerpt: Learn how to use the ConvertKit API to publish past issues of your newsletter to your Next.js site.
tags: [react, next.js, convertkit, tutorial, api]
date: 09-23-2022
published: true
coverImagePublicId: 'posts/publish-your-newsletter-with-convertkit-api-next-js/cover.png'
path: publish-your-newsletter-with-convertkit-api-next-js
---
    ...
    <>
      ...
      <Stack>
        {newsletters?.map((newsletter) => (
          <Link
            href={`/newsletter/${slugify(newsletter.subject)}`}
            key={newsletter.id}
          >
