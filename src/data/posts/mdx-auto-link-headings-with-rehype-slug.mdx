---
title: 'MDX Tips: Link to headings in your mdx posts automatically with rehype'
date: 01-02-2022
excerpt: 'This tutorial will teach you how to automatically add links to heading tags in your mdx posts. This should work for most nextJS sites that use MDX for content, as well as many other JavaScript-based sites which use MDX.'
published: true
