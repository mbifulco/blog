---
title: '3 tips to fix stubborn TypeScript errors with VS Code'
excerpt: "Sometimes fixing a TypeScript or eslint error in VS Code can feel impossible. Here's what I do when I have tried everything else."
