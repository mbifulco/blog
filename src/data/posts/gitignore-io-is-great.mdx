...
Put simply, [gitignore.io](https://gitignore.io) is a that is so profoundly helpful that I've _forgotten what life was like without it._
...
<Aside type="info">
  <small>
    ...
    sponsored post. I <strike>do</strike> <em>(update: 11/2020) used to</em> work for{' '}
    <a href="https://aquent.com?utm_campaign=mikebifulco&utm_source=mikebifulco.com&utm_content=gitignore-io-is-great" target="_blank" rel="noopener noreferrer">
      Aquent
    </a>
    , which is a creative staffing agency. If you're looking for work, give <strike>us</strike> them a look!).
  </small>
</Aside>
