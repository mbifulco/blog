---
title: How Stripe Uses Friction Logs to Improve their Products
excerpt: A guide to friction logging, a practice that can be used by engineering teams building products to track and improve upon issues that users experience while using a product.
date: 2022-09-16
tags: [devrel, product]
slug: how-stripe-uses-friction-logs
coverImagePublicId: posts/how-stripe-uses-friction-logs/cover
---
...
- You may also want to check out frictionlog.com - they provide lots of great articles, examples, and resources on Friction logging. _(Update: frictionlog.com is no longer online.)_
