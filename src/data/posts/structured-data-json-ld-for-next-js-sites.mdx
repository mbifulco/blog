...
<FAQ>
  <FAQItem question="What is JSON-LD?">
  ...
  <FAQItem question="What is the difference between JSON-LD and Structured Data?">
  ...
  <FAQItem question="How do I add JSON-LD to a Next.js site?">
  ...
  <FAQItem question="Why should JSON-LD be rendered server-side?">
  ...
  <FAQItem question="How do I test and validate my Structured Data?">
