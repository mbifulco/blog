...
I worked as Technical Director for an online code school (aka'd as a MOOC, for Massively Online Open Course) www.thegymnasium.com from 2014-2020, and during that time, I did a weekly livestream of my work on twitch [twitch.tv/irreverentmike](https://www.twitch.tv/irreverentmike) just about every week for 2-4 hours. It's something I was able to do because everything Gymnasium does is Open Source - you can peruse the source code that powers [Gymnasium on Github](https://github.com/gymnasium).
