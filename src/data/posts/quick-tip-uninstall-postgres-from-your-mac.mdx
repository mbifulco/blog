...
published: true
path: quick-tip-uninstall-postgres-from-your-mac
tags: [dev]
---
...
I don't want to take any credit for the work - it seems to have originally come from [this blog post](http://hzchirs-blog.logdown.com/posts/142678-how-completely-uninstall-postgresql-9x-on-mac-osx) from 2013, which was not returned by my Bing-fu (yeah, you read that right).  
