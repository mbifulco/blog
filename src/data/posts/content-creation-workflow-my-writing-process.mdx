...
1. I create a file for each new post in [the source code for my site](https://github.com/mbifulco/blog) under the `src/data/newsletters` directory, as a single `.mdx` file with a small amount of frontmatter (title, desctiption, tags, slug, and a cover image).
