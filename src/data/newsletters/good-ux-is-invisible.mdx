...
🎯 Target execs recently showed off their liquid spines by axing DEI programs, which resulted in a dramatic drop in store traffic. _(Update: the source article is no longer available.)_
