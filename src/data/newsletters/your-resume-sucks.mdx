...
description: "A guide to writing a resume that doesn't suck, from a hiring manager's perspective."
date: 2023-10-04
tags: ['career']
...
I've read through several applications that include nothing more than a name and an email address. No resume, no cover letter, no LinkedIn profile, not even a GitHub link. These applications are rejected immediately.
...
What do you think? Did I get anything really wrong here? Is there something you've done or seen that helps people land an interview? If you have any questions, comments, or feedback, I wanna hear it. Please reach out to me on [Mastodon](https://hachyderm.io/@irreverentmike), [Threads](https://threads.net/@irreverentmike) or [shoot me an email](mailto:hello@mikebifulco.com).

---

## Recommendations from around the web

- 📖 I'm currently reading through [Oversubscribed](https://www.amazon.com/Oversubscribed-How-People-Lined-Business/dp/B085P1N7LR/ref=sr_1_1?keywords=oversubscribed&qid=1696419802&sr=8-1), by Daniel Priestly. It's got some great insights on how to build a business whose demand exceeds its supply, and how to use that to your advantage.
- 🎨 I recently found out that the [Washington Post's Design System](https://build.washingtonpost.com/foundations/color) is published online for anyone to check out (shout out to my pal Edward for sharing!). If you're at all interested in building UI libraries or design systems, give it a look.
- 📰 [What not to do in API Versioning](https://apisyouwonthate.com/newsletter/api-versioning-what-not-to-do/) is the latest newsletter from APIs You Won't Hate, the dev community I help run. It's a great read on a hairy topic, especially if you're building APIs.
