...
- 💬 Shared the fix in the original GitHub thread to unblock others
...
- [cmgriffing on Twitch](https://www.twitch.tv/cmgriffing) — streams dev work and product experiments
- [Rizel Scarlett (aka blackgirlbytes)](https://www.twitch.tv/blackgirlbytes1) — open source, conference prep, and community vibes
