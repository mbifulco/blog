...
<Image
  publicId="newsletters/shrimps-is-bugs/cover"
  alt="Shrimps is bugs: Red Lobster ate itself to death"
/>
...
So, friends:
<Highlight>if you're working on your business plan, try not to include an all-you-can-eat shrimp promotion in the mix.</Highlight>
