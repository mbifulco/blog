...
excerpt: '"Unreasonable Hospitality" by Will Guidara outlines how to making customers feel exceptionally special. Let's bring these hospitality principles to tech, by creating memorable experiences, and using hospitality to elevate customer satisfaction in product design, engaging with the people using our products.'
