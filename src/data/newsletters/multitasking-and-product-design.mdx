...
<Image
  publicId="newsletters/multitasking-and-product-design/cover"
  alt="multitasking and product design"
  caption={
    <span>
      Photo by{' '}
      <a href="https://unsplash.com/it/@norevisions?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">
        No Revisions
      </a>{' '}
      on{' '}
      <a href="https://unsplash.com/photos/7aKbIqfIEMw?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">
        Unsplash
      </a>
    </span>
  }
