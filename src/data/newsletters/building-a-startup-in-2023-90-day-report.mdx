...
description: "I'm building a new company for the first time since 2016. A lot has changed since then. Here's what feels different this time around."
date: 04-06-2023
tags: [newsletter, startup, founder]
slug: building-a-startup-in-2023-90-day-report
coverImagePublicId: newsletter/building-a-startup-in-2023-90-day-report/cover
---
...
### 1. The bar for design and branding is higher than ever
...
### 2. Automation and tooling are the real 10x engineer
...
Critically, there's been enough time for _all_ of the automation tools to see competitors arise. This forces companies building tools to be innovative and keep raising the bar for what they make. Here's a few choices I've found myself with:
...
- For **no-code, event-driven automation**: [IFTTT](https://ifttt.com/) is the OG, but continues to become more consumer-focused. [Zapier](https://zapier.com/) has arisen as a popular choice, but I've found myself exploring other options like [Make](https://make.com/), [Trigger.dev](https://trigger.dev/) and [n8n](https://n8n.io/).

### 3. A focus on Developer Experience (DX) is a competitive advantage
...
- For **git-driven deployments (CD)** - [Vercel](https://vercel.com) and [Netlify](https://netlify) are both fantastic. I use both across the sites I maintain, and they're both great. We're using Vercel for Craftwork, and .
...
I sat down to write this newsletter thinking I'd throw out a few quick bullet points about how the world of devtools has changed in the past few years. I didn't expect to write a 2000 word essay, but here we are. I hope this has been helpful to you, and I hope you'll take a look at some of the tools I've mentioned here. If you have any questions, feel free to reply to this email or drop me a line on Mastodon [@irreverentmike@hachyderm.io](https://hachyderm.io/@irreverentmike).
