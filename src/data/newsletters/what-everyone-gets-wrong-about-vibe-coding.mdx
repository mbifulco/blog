...
_Vibe coding,_ in short, is when someone uses code-trained LLMs to write software, by writing instructions in plain English rather than writing code. Compare this to traditional softwar engineering, where a disgruntled developer pulls their hair out while yelling at their computer and slamming their hands on the keyboard until things work.
...
<Image
  src="/images/newsletters/what-everyone-gets-wrong-about-vibe-coding/it-did-quit-once"
  alt="Even the robots give up sometimes."
  capation="Even the robots give up from time to time."
/>
