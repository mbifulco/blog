...
<Image
  publicId="newsletters/learn-from-a-dunning-kruger-expert/cover"
  alt="Left side: I am a Dunning-Kruger expert. Right side: the dunning-kruger chart, with an arrow pointing to the leftmost peak that is labeled 'Its ya boy'."
/>
