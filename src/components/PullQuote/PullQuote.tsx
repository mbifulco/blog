...
const PullQuote: React.FC<PullQuoteProps> = ({
  ...
  return (
    ...
    >
      <div className="font-serif text-lg italic text-slate-700 dark:text-slate-200">
        {children}
      </div>

      {author && (
        <footer className="mt-4">
          <cite className="flex items-center text-sm font-medium not-italic text-slate-600 dark:text-slate-400">
